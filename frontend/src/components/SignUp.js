    ...
    return (
        ...
        <form onSubmit={handleSubmit} style={{paddingLeft:"20%", paddingRight:"20%"}} className="container mt-3">
            ...
            <div className="col-md-6 mb-2">
                ...
                <input pattern="[6789][0-9]{9}" name="phno" className="signup-input form-control" onChange={onChange } id="phno" required minLength={10} maxLength={10} placeholder="10 digits only" />
            </div>
            </div>
            <div className="mb-2">
            ...
            <button type="submit" className="btn signup-btn btn-lg my-3">SignUp</button>
            </div>
            </div>
            <div className="row">
            <div className="col-md-12">
